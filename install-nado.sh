#!/bin/bash
#
# NOFX Nado Edition - One-Click Installation Script
# https://github.com/wjlkkk/nofx_Nado
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/wjlkkk/nofx_Nado/dev/install-nado.sh | bash
#
# Or with custom directory:
#   curl -fsSL https://raw.githubusercontent.com/wjlkkk/nofx_Nado/dev/install-nado.sh | bash -s -- /opt/nofx
#
...
GITHUB_RAW="https://raw.githubusercontent.com/wjlkkk/nofx_Nado/dev"
...
download_files() {
    echo -e "${YELLOW}Downloading configuration files from Nado Edition...${NC}"
